        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="fw-bold container-header py-2" style="text-align:center; color: black;">
                        <h1 style="font-size: 30px;">Informacion de baja:</h1>
                    </div>
                    ...
                    <div class="container-section">
                        <div class="row justify-content-center">
                            <div class="col-sm-4">
                                ...
                                <input type="date" name="fechaBaja" id="fechaBaja" class="form-control input-sm" readonly>
                            </div>
                            <div class="row justify-content-between">
                                <div class="col justify-content-between">
                                    ...
                                    <input style="width: 345px;" type="text" name="motivo" id="motivo" class="form-control input-sm" readonly>
                                </div>
                                <div class="col justify-content-between">

                                    <label>Observaciones:</label>

                                    <input style="width: 345px;" type="text" name="observaBaja" id="observaBaja" class="form-control input-sm" readonly>
                                </div>
                            </div>
                            <div class="col-sm-4">
                                <center>
                                ...
                                <input type="text" name="liquida" id="liquida" class="form-control input-sm" readonly>
                            </div>
                        </div>
                    </div>
                </div>
