...
function getLogin(user, pass) {
    ...
    return fetch('controller/controllerLogin.php?opc=validateUser', options)
      .then(res => res.json())
      .then(data => data);
}

document.getElementById('viewPass').onmousedown = function(){        
    document.getElementById('pass').type = 'text';
};

document.getElementById('viewPass').onmouseup = function(){        
