...
$data = $request->getEmployeeMale($d);
?>
...
<head>
    ...
    <title>Lista de personal masculino</title>    
</head>
<style>
    .header {
    ...
    <table border="1">
        ...
        <?php
            if (empty($data)) {
                ?>
                <tr>
                    <td style="padding-bottom: 10px;padding-top: 10px;" colspan="2" >No hay empleados en este departamento</td>
                </tr>                
            <?php
            } else {
                foreach($data as $d){
...
$dompdf->stream('Lista_personal_masculino_'.$dep.'.pdf', array("Attachment" => false));
